...
function AddHelpdeskLink() {
    var jsionObject = jQuery.parseJSON(sessionStorage.getItem('currentUser'));
   // jQuery.parseJSON(sessionStorage.getItem('currentUser')).pCoreUserId
    //var IJPPCoreUserId = localStorage.getItem('IJPPCoreUserId');
    if (jsionObject != null && jsionObject.pCoreUserId > 0 && jsionObject.pCoreUserId != 9999) {
        ...
        $('#hlpIframe').attr('src', 'http://10.4.32.51:8079/Main/Ticket.aspx?q=' + jsionObject.pCoreUserId);
    }
}
